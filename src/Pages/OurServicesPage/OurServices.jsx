...
// Dynamic imports for static images
const staticImages = {
  Pic1: () => import("../../assets/os-pic1.png"),
  Pic2: () => import("../../assets/os-pic2.png"),
  Pic3: () => import("../../assets/os-pic3.png"),
  Pic4: () => import("../../assets/os-pic4.png")
};
  ...
  return (
    <div className='os-container'>
      <div className="os-section1">
        ...
        <p className="os-section1-text2">
          Get highly-performing, fully functional and secure web experiences that are able to scale as your business grows. Our front-end and back-end development team is here to help you improve, redesign, or build your website from a scratch.
        </p>
      </div>
      ...
      <div className="os-section2">
        ...
        <div className="os-section2-content1">
          ...
          <OptimizedImage 
            src={staticImages.Pic2}
            alt="Customized Systems"
            className="os-section2-content1-image"
          />
        </div>
      ...
      <div>
        {selectedProjects.map((item) => (
          <div 
            ...
            className="oww-section2-content1-wrapper"
          >
            ...
            <div className="oww-section2-content1-image-cont">
              <OptimizedImage 
                src={item.image}
                alt={item.title}
                className="oww-section2-content1-image"
              />
            </div>
              ...
              <div className="oww-section2-content1-tags">
                <div className="oww-section2-content1-tags-cont">
                  {item.devTags.map((tag, index) => (
                    <p key={index} className="oww-section2-content1-tag1">{tag.tag}</p>
                  ))}
                </div>
