    ...
    <div className='os-container'>
      ...
      <div className="os-section2">
        <div className="os-section2-content1">
          <img loading="lazy" src={Pic1} alt="os-pic" className="os-section2-content1-image2" />
        ...
        <div className="os-section2-content1">
          ...
          <img loading="lazy" src={Pic2} alt="os-pic" className="os-section2-content1-image" />
        </div>
        <div className="os-section2-content1">
          <img loading="lazy" src={Pic3} alt="os-pic" className="os-section2-content1-image" />
          <div className="os-section2-content1-text-wrapper">
        ...
        <div className="os-section2-content1">
          ...
          <img loading="lazy" src={Pic4} alt="os-pic" className="os-section2-content1-image" />
        </div>
      </div>
      <div>
        {
          selectedProjects.map((item) => (
            <div id={item.id} key={item.id} style={{ backgroundColor: item.backgroundColor }} className="oww-section2-content1-wrapper">
              ...
              <div className="oww-section2-content1-image-cont">
                <img loading="lazy" src={item.image} alt="ow-image" className="oww-section2-content1-image" />
              </div>
